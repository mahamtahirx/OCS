...
const SparePartsList = () => {
  ...
  if (window.confirm('Are you sure you want to delete this spare part?')) {
    axios.delete(`http://localhost:28000/Spare-parts/spareparts/${id}/`)
      .then(() => fetchData())
      .catch(err => console.error(err));
    }
  };
  ...
  return (
    <div className="p-4">
      <h3 className="text-white mb-3 text-center text-decoration-underline">Spare Parts Inventory</h3>
                ...
                return (
                  <tr key={part.id} className={isLowStock ? 'bg-red-700' : ''}>
                    ...
                    <td className="border px-2 py-2">
                      ...
                      {/* <Button variant="outline-light" className='me-2 mb-2' onClick={() => handleDemand(part.id)}>Demand</Button> */}
                    </td>
                  </tr>
                );
              })}
