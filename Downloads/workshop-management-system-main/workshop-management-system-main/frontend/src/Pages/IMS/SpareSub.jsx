...
const SparePartsSub = () => {
  ...
  const fetchData = () => {
    axios.get('http://localhost:28000/Spare-parts/spareparts/')
      .then(res => {
         // Only include parts with location === 'Sub Store'
          setSpareParts(res.data.filter(part => part.location === 'Sub Store'));
        })
  ...
  return (
    <div className="p-4">
      <h3 className="text-white mb-3 text-center text-decoration-underline">Sub Store Inventory</h3>
